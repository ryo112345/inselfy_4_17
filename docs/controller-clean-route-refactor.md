...
| 6 | [ ] | interview_controller.go | 642 | **ハイブリッド**: pool + ConversationRepository 等の port + TxManager を持つ。日程調整ロジックの interactor 抽出が本体。**事前分析済み → `docs/interview-controller-migration-notes.md` を必ず読む** |
