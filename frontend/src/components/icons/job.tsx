// 求人ページ群（company/jobs/{new,[jobId],preview}, test/jobs/{edit,view}, jobs/[jobId]）で
// 共有するアイコン集。className のデフォルト値は移動前のハードコード値を維持している。
// profile 由来の src/components/icons/index.tsx とは同名でも形状が異なるものがあるため別モジュール。
