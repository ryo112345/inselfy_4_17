 ...
 */
export const careerInterestCiRequestAiReport = <ThrowOnError extends boolean = false>(options: Options<CareerInterestCiRequestAiReportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CareerInterestCiRequestAiReportResponse, CareerInterestCiRequestAiReportError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 * 未読（未開封）スカウト数（要ログイン）
 */
export const candidateScoutsCountCandidateUnreadScouts = <ThrowOnError extends boolean = false>(options?: Options<CandidateScoutsCountCandidateUnreadScoutsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<CandidateScoutsCountCandidateUnreadScoutsResponse, CandidateScoutsCountCandidateUnreadScoutsError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 */
export const searchSearchAll = <ThrowOnError extends boolean = false>(options: Options<SearchSearchAllData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchSearchAllResponse, SearchSearchAllError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 * 記事検索（要ログイン）
 */
export const searchSearchArticles = <ThrowOnError extends boolean = false>(options: Options<SearchSearchArticlesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchSearchArticlesResponse, SearchSearchArticlesError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 * 求人検索（要ログイン）
 */
export const searchSearchJobs = <ThrowOnError extends boolean = false>(options: Options<SearchSearchJobsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchSearchJobsResponse, SearchSearchJobsError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 * 投稿検索（要ログイン）
 */
export const searchSearchPosts = <ThrowOnError extends boolean = false>(options: Options<SearchSearchPostsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchSearchPostsResponse, SearchSearchPostsError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 * ユーザー検索（要ログイン）
 */
export const searchSearchUsers = <ThrowOnError extends boolean = false>(options: Options<SearchSearchUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchSearchUsersResponse, SearchSearchUsersError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
 ...
 */
export const teamDiagnoseStartDiagnoseCiSession = <ThrowOnError extends boolean = false>(options: Options<TeamDiagnoseStartDiagnoseCiSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamDiagnoseStartDiagnoseCiSessionResponse, TeamDiagnoseStartDiagnoseCiSessionError, ThrowOnError>({
 ...
 */
export const teamDiagnoseSubmitDiagnoseCiResult = <ThrowOnError extends boolean = false>(options: Options<TeamDiagnoseSubmitDiagnoseCiResultData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamDiagnoseSubmitDiagnoseCiResultResponse, TeamDiagnoseSubmitDiagnoseCiResultError, ThrowOnError>({
 ...
 */
export const teamDiagnoseStartDiagnoseWvSession = <ThrowOnError extends boolean = false>(options: Options<TeamDiagnoseStartDiagnoseWvSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamDiagnoseStartDiagnoseWvSessionResponse, TeamDiagnoseStartDiagnoseWvSessionError, ThrowOnError>({
 ...
 */
export const teamDiagnoseSubmitDiagnoseWvResult = <ThrowOnError extends boolean = false>(options: Options<TeamDiagnoseSubmitDiagnoseWvResultData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamDiagnoseSubmitDiagnoseWvResultResponse, TeamDiagnoseSubmitDiagnoseWvResultError, ThrowOnError>({
 ...
 * AIレポートの作成依頼（セッション所有者のみ・冪等）
 */
export const workValuesWvRequestAiReport = <ThrowOnError extends boolean = false>(options: Options<WorkValuesWvRequestAiReportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<WorkValuesWvRequestAiReportResponse, WorkValuesWvRequestAiReportError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'inselfy_token',
