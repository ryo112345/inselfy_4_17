...
export default function CompanyProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl pb-28">
      ...
      {toast && (
        <div
          className={`fixed bottom-20 left-1/2 z-50 -translate-x-1/2 transition-all duration-300 ease-out ${toastVisible ? "translate-y-0 opacity-100" : "translate-y-2 opacity-0"}`}
        >
          <div
