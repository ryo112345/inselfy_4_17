...
const navItems = [
  ...
  { label: "みつける", href: "/search", icon: SearchIcon },
  { label: "よむ", href: "/articles", icon: ArticleIcon },
  { label: "さがす", href: "/jobs", icon: BuildingIcon },
  { label: "つくる", href: "/articles/mine", icon: PenIcon },
