  ...
  return (
    <div className="min-h-screen md:pl-[50px] bg-[#f6f7f5]">
      <div className="max-w-[800px] mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 px-6 py-5 mb-4">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  ...
                  {message.jobTitle && message.jobPostingId && (
                    <Link
                      href={`/jobs/${message.jobPostingId}`}
                      className="text-xs text-gray-500 hover:text-[#3D8B6E] truncate block transition-colors"
                    >
                      {message.jobTitle}
                    </Link>
                  )}
          ...
          <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <Link
                href={`/companies/${message.companyId}`}
                className="inline-flex items-center gap-1 text-xs text-gray-500 hover:text-[#3D8B6E] transition-colors"
              >
            ...
            {message.expiresAt && (
              ...
              >
                返信期限: {formatDate(message.expiresAt)}
                {remaining && ` (${remaining})`}
              </span>
            )}
          </div>
        ...
        {/* Subject + body */}
        <div className="bg-white rounded-xl border border-gray-200 px-6 py-6 mb-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 px-6 py-5 mb-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={responding}
                className="bg-[#3D8B6E] text-white px-6 py-2.5 rounded-lg hover:bg-[#347a5f] disabled:opacity-50 font-medium text-sm transition-colors"
              >
                {responding ? "処理中..." : "興味あり"}
              </button>
              <button
                ...
                disabled={responding}
                className="border border-gray-200 text-gray-500 px-6 py-2.5 rounded-lg hover:bg-gray-50 disabled:opacity-50 text-sm transition-colors"
              >
                辞退する
              </button>
            </div>
