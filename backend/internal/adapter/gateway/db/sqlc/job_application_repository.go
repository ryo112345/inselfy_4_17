...
func (r *JobApplicationRepository) ListByCompanyID(ctx context.Context, companyID string, status *string, limit, offset int) ([]*jobapplication.JobApplicationWithDetails, int, error) {
	q := queriesForContext(ctx, r.queries)
