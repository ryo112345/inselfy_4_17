...
func PostSingleResponse(pw *post.PostWithUser) openapi.ModelsPostResponse {
	return *postConv.ToPostResponse(pw)
}

// PostsListResponse converts a paginated list of posts to its API response.
func PostsListResponse(posts []*post.PostWithUser, total int) openapi.ModelsPostListResponse {
...
func PostLikeToggleResponse(liked bool, count int) openapi.ModelsLikeToggleResponse {
...
func PostRepostToggleResponse(reposted bool, count int) openapi.ModelsRepostToggleResponse {
...
func PostCommentResponse(c *post.CommentWithUser) openapi.ModelsCommentResponse {
	return *postConv.ToCommentResponse(c)
}

// PostCommentsListResponse converts a paginated list of comments to its API response.
func PostCommentsListResponse(comments []*post.CommentWithUser, total int) openapi.ModelsCommentListResponse {
