...
func FollowStatusResponse(status *follow.FollowStatus) openapi.ModelsFollowStatusResponse {
...
func FollowUsersResponse(users []*follow.FollowWithUser, total int) openapi.ModelsFollowUserListResponse {
