...
func SkillResponse(s *skill.UserSkill) openapi.ModelsSkillResponse {
	return *toSkillResponse(s)
}

// SkillsResponse converts a list of user-skills to its API response.
func SkillsResponse(ss []*skill.UserSkill) openapi.ModelsSkillListResponse {
